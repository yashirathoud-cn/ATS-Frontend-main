...
const ImproveResume5 = () => {
  ...
  const openPrintDialog = () => {
    ...
    printContainer.style.width = "240mm";
    printContainer.style.height = "297mm";
    printContainer.style.background = "#FFFFFF";
 
    const resumeElement = document
      .querySelector(`.${templates[selectedTemplate].resumeClass.split(" ").join(".")}`)
      .cloneNode(true);
    ...
    const elementsToRemove = resumeElement.querySelectorAll(
      "button, select, .group-hover\\:opacity-100, .opacity-0, input, textarea, .mt-8"
    );
    ...
    style.textContent = `
      @media print {
        ...
        .${templates[selectedTemplate].resumeClass.split(" ").join(".")} {
          max-width: 100% !important;
          width: 100% !important;
          padding: ${selectedTemplate === "template1" ? "8mm" : "10mm"} !important;
          margin: 0 !important;
          background: #FFFFFF !important;
          flex-grow: 1;
        ...
        .${templates[selectedTemplate].headerClass.split(" ").join(".")} {
          background: ${selectedTemplate === "template1" ? "#F5E8C7" : "#1e3a8a"} !important;
          color: ${selectedTemplate === "template1" ? "#000000" : "#ffffff"} !important;
          width: 100% !important;
          padding: ${selectedTemplate === "template1" ? "6pt" : "8pt"} !important;
          text-align: center !important;
        }
        h2 {
          font-size: ${selectedTemplate === "template1" ? "20pt" : "24pt"} !important;
          font-weight: bold !important;
          color: ${selectedTemplate === "template1" ? "#15803D" : "#1e40af"} !important;
          border-bottom: 2pt solid ${
            selectedTemplate === "template1" ? "#DCFCE7" : "#bfdbfe"
          } !important;
        ...
        svg {
          stroke: ${selectedTemplate === "template1" ? "#1E3A8A" : "#1d4ed8"} !important;
        }
        .border-gray-300 {
  ...
  const EditToolbar = () => (
    <div className="!bg-white text-gray-700 rounded shadow-md p-2 inline-flex items-center space-x-1 z-20">
      <button className="p-1.5 hover:bg-gray-300 rounded-full" onClick={() => applyFormatting("bold")} title="Bold">
        <svg
      ...
      <button className="p-1.5 hover:bg-gray-300 rounded-full" onClick={() => applyFormatting("italic")} title="Italic">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
      ...
      <button
        className="p-1.5 hover:bg-gray-300 rounded-full"
      ...
      <button className="p-1.5 hover:bg-gray-300 rounded-full" onClick={() => applyFormatting("list")} title="List">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
      ...
      <button className="p-1.5 hover:bg-gray-300 rounded-full" onClick={() => applyFormatting("bullet")} title="Bullet">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
      ...
      <button className="p-1.5 hover:bg-gray-300 rounded-full" onClick={() => applyFormatting("circle")} title="Circle">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
      ...
      <button className="p-1.5 hover:bg-gray-300 rounded-full" onClick={() => applyFormatting("box")} title="Box">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
  ...
  const templates = {
    template1: {
      containerClass: "min-h-screen bg-white flex items-center justify-center p-4",
      resumeClass: "bg-white max-w-3xl w-full p-6 rounded-lg shadow-md",
      headerClass: "bg-[#F5E8C7] text-black text-center py-4 rounded-t-lg",
      titleClass: "text-2xl font-bold",
      subtitleClass: "text-lg",
      sectionClass: "mt-6",
      sectionTitleClass: "text-lg font-bold text-green-800 border-b-2 border-green-200 pb-2",
      textContentClass: "mt-2 text-gray-900 leading-relaxed",
      listContentClass: "mt-2 text-gray-900",
      experienceTitleClass: "font-semibold",
      experienceFieldClass: "ml-4",
      experienceDescriptionClass: "list-disc list-outside ml-8 mt-1 space-y-1",
      listItemClass: "list-disc list-outside ml-6 space-y-1",
    },
    template2: {
      containerClass: "min-h-screen bg-gray-100 flex items-center justify-center p-4",
      resumeClass: "bg-white max-w-4xl w-full p-8 rounded-xl shadow-lg",
      headerClass: "bg-blue-800 text-white text-center py-6 rounded-t-xl",
      titleClass: "text-3xl font-bold",
      subtitleClass: "text-xl",
      sectionClass: "mt-8",
      sectionTitleClass: "text-xl font-bold text-blue-900 border-b-4 border-blue-200 pb-3",
      textContentClass: "mt-3 text-gray-800 leading-relaxed",
      listContentClass: "mt-3 text-gray-800",
      experienceTitleClass: "font-semibold text-blue-900",
      experienceFieldClass: "ml-6",
      experienceDescriptionClass: "list-circle list-outside ml-10 mt-2 space-y-2",
      listItemClass: "list-circle list-outside ml-8 space-y-2",
    },
  };
  ...
  const renderSection = (sectionKey, sectionData) => {
    ...
    if (sectionData.type === "text") {
      return (
        <section key={sectionKey} className={`${sectionClass} relative group`}>
          ...
          {editingSection === sectionKey ? (
            <div className="relative mt-4">
              ...
              <input
                type="text"
                className="w-full mb-3 p-3 text-gray-700 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-200"
                value={editTitle}
              ...
              <textarea
                id="editTextarea"
                className="w-full h-48 p-3 border text-gray-700 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-200"
                value={editContent}
            ...
            <div className={listContentClass}>
              {sectionKey === "<strong>Work Experience</strong>" || sectionKey === "<strong>Projects</strong>" ? (
                      ...
                      {Array.isArray(item) ? (
                        item.map((field, idx) => (
                          <div key={idx}>
                            {field.type === "title" && (
                              <p
                                className={`${experienceTitleClass} text-gray-900`}
                                dangerouslySetInnerHTML={{ __html: field.value }}
                              ></p>
                            )}
                            {field.type === "field" && (
                              <p
                                className={`${experienceFieldClass} text-gray-900 font-bold`}
                                dangerouslySetInnerHTML={{ __html: field.value }}
                              ></p>
                            )}
                            {field.type === "description" && (
                              <ul className={experienceDescriptionClass}>
                        ...
                        <p className="text-gray-900" dangerouslySetInnerHTML={{ __html: item }}></p>
                      )}
                    </div>
                  ))}
                </div>
                ...
                <ul className={listItemClass}>
                  {contentArray.map((item, index) => (
                    <li key={index} className="text-gray-900" dangerouslySetInnerHTML={{ __html: item }}></li>
                  ))}
                </ul>
              )}
            </div>
    ...
    <div className=" bg-black flex flex-col items-center p-4">
      <div className="mb-4">
        <select
          ...
          className="p-2 border border-gray-300 text-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          <option value="template1">Template 1</option>
          <option value="template2">Template 2</option>
        </select>
      </div>
      <div className={templates[selectedTemplate].containerClass}>
        {resumeData?.pages.map((page, pageIndex) =>
          currentPage === pageIndex && (
            <div key={pageIndex} className={templates[selectedTemplate].resumeClass}>
              <div className={templates[selectedTemplate].headerClass}>
                <h1 className={templates[selectedTemplate].titleClass}>{page.header.name}</h1>
                <p className={templates[selectedTemplate].subtitleClass}>{page.header.contact}</p>
                <p className={templates[selectedTemplate].subtitleClass}>
      ...
      <div className="bg-white text-gray-700 p-6 rounded-xl shadow-lg w-full max-w-4xl mb-8">
...
export default memo(ImproveResume5);